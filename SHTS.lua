...
Funcs:NewButton("Use codes", "Uses all possible codes", function()
	game:GetService("ReplicatedStorage").remotes.EnterCode:FireServer("FOURKGROUPMEMBERS")
	game:GetService("ReplicatedStorage").remotes.EnterCode:FireServer("ONEHUNDREDKVISITSOMG")
	game:GetService("ReplicatedStorage").remotes.EnterCode:FireServer("FIVEHUNDREDLIKES")
	game:GetService("ReplicatedStorage").remotes.EnterCode:FireServer("ONEKFAVORITES")
