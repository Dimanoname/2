...
local themeStyles = {
	Useless = {
	    SchemeColor = Color3.fromRGB(152,52,227),
    ...
    Midnight = {
        SchemeColor = Color3.fromRGB(50, 0, 208),
        Background = Color3.fromRGB(10, 10, 10),
...
function Kavo.CreateLib(kavName, themeList)
    ...
    if themeList == "Useless" then
        themeList = themeStyles.Useless
    ...
    MainSide.Size = UDim2.new(0, 149, 0, 300)
